...
/*package*/ class SignalTransition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.sensor$cf7r;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.sensor$cf7r);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ou4d0n_b0");
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.value$$qVW;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink sensor$cf7r = MetaAdapterFactory.getReferenceLink(0xebc7d5848dc64f91L, 0xa9e8fcd9cb7722d1L, 0x5e58140c4c4bbdf6L, 0x2cc780f97e9e6eafL, "sensor");
  }
